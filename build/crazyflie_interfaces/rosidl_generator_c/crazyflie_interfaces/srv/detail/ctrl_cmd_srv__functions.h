...
#ifndef CRAZYFLIE_INTERFACES__SRV__DETAIL__CTRL_CMD_SRV__FUNCTIONS_H_
#define CRAZYFLIE_INTERFACES__SRV__DETAIL__CTRL_CMD_SRV__FUNCTIONS_H_
...
/// Initialize srv/CTRLCmdSrv message.
/**
...
/// Finalize srv/CTRLCmdSrv message.
/**
...
/// Create srv/CTRLCmdSrv message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * crazyflie_interfaces__srv__CTRLCmdSrv_Request__init().
...
/// Destroy srv/CTRLCmdSrv message.
/**
 * It calls
 * crazyflie_interfaces__srv__CTRLCmdSrv_Request__fini()
...
/// Check for srv/CTRLCmdSrv message equality.
/**
...
/// Initialize array of srv/CTRLCmdSrv messages.
/**
...
/// Finalize array of srv/CTRLCmdSrv messages.
/**
 * It calls
 * crazyflie_interfaces__srv__CTRLCmdSrv_Request__fini()
...
/// Create array of srv/CTRLCmdSrv messages.
/**
 * It allocates the memory for the array and calls
 * crazyflie_interfaces__srv__CTRLCmdSrv_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/CTRLCmdSrv messages.
/**
 * It calls
 * crazyflie_interfaces__srv__CTRLCmdSrv_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/CTRLCmdSrv message array equality.
/**
...
/// Copy an array of srv/CTRLCmdSrv messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * crazyflie_interfaces__srv__CTRLCmdSrv_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_crazyflie_interfaces
...
/**
 * It calls
 * crazyflie_interfaces__srv__CTRLCmdSrv_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_crazyflie_interfaces
...
/**
 * It allocates the memory for the array and calls
 * crazyflie_interfaces__srv__CTRLCmdSrv_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_crazyflie_interfaces
...
/**
 * It calls
 * crazyflie_interfaces__srv__CTRLCmdSrv_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // CRAZYFLIE_INTERFACES__SRV__DETAIL__CTRL_CMD_SRV__FUNCTIONS_H_
